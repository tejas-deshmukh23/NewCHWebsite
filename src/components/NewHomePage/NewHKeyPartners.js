...
import experian from "../../images/EXP.png";
...
function NewHKeyPartners(){
    return (
        ...
        <>
      <div className="Keypartner-s">
    <h1 style={{ marginTop : '15px',textAlign :' center', fontFamily:'Open Sans, sans-serif',color:"#3e2780"}}>Key partners</h1>
    <div className="gridContainer">
          {/* Grid items (columns) */}
          {/* <div className={styles.gridItem}>All rights reserved</div> */}
          <div className="gridItem-n">
          <div><img className="NewKeyPartnersImg1" src={experian} /></div>
        </div>
        <div className="gridItem-n">
