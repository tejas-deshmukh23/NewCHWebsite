...
Working with multiple financial<br className='desktoponlys'/> institutes allows CreditHaat to offer personal
loans up to ₹50 Lacs.</p>
</div>
</>
    );
}
