...
import './CcardEMI.css'; // Import external CSS file
...
const CcardEMI = () => {
  ...
  <div class="table-container">
      ...
      <tbody>
        <tr>
          <td>
            <ul>
              <br></br>
              <li style={{fontSize: "18px"}}><p>Limits: up to Rs10 Lacs</p></li>
              <li style={{fontSize: "18px"}}><p>Approval: same day approval</p></li>
              <li style={{fontSize: "18px"}}><p>Card out: card delivery within 48 hours</p></li>
            </ul>
          </td>
        </tr>
      </tbody>
    ...
    <table class="table-right">
      <thead>
        <tr>
          <th style={{fontWeight:"normal",color:"#3e2780"}}> Credit card eligibility</th>
        </tr>
      </thead>
      <tbody>
        <tr>
